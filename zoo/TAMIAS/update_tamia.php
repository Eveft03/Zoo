...
try {
    ...
    try {
        ...
        if (!$stmt->execute()) {
            throw new Exception("Σφάλμα κατά την ενημέρωση του ταμία: " . $stmt->error);
        }
        ...
        $db->commit();
        echo json_encode(['status' => 'success', 'message' => 'Ο ταμίας ενημερώθηκε επιτυχώς'], JSON_UNESCAPED_UNICODE);
